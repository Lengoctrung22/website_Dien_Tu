  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
      ...
      <div className="flex items-center gap-1.5 text-xs font-mono text-slate-600 dark:text-slate-400 flex-wrap font-medium">
        <Link href="/" className="hover:text-cyan-700 dark:hover:text-signal-cyan transition-colors">Trang chủ</Link>
        <ChevronRight className="w-3.5 h-3.5" />
        <Link href={`/products?category=${product.category}`} className="hover:text-cyan-700 dark:hover:text-signal-cyan capitalize transition-colors">
          {product.category}
        </Link>
        <ChevronRight className="w-3.5 h-3.5" />
              ...
              {product.images.map((img: string, index: number) => (
                <button
                  ...
                  className={`relative w-20 h-20 rounded-xl overflow-hidden flex-shrink-0 border hairline-border surface-bevel transition-all ${
                    selectedImage === img
                      ? 'ring-2 ring-cyan-600 dark:ring-signal-cyan scale-95 shadow-md'
        ...
        <div className="lg:col-span-6 space-y-6 flex flex-col justify-between">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <span className="px-2.5 py-1 rounded-md text-xs font-mono font-bold uppercase tracking-wider bg-surface-card text-cyan-700 dark:text-signal-cyan border border-cyan-500/30">
                {product.brand}
              </span>
            ...
            <div className="p-4 rounded-xl bg-surface-card border hairline-border surface-bevel flex items-center gap-4">
              <div>
                <div className="text-2xl sm:text-3xl font-mono tabular-nums font-black text-cyan-700 dark:text-signal-cyan">
          ...
          <div className="grid grid-cols-3 gap-3 p-4 rounded-xl bg-surface-card border hairline-border surface-bevel text-center text-xs text-slate-700 dark:text-slate-400 font-mono font-semibold">
            <div className="flex flex-col items-center gap-1">
              <ShieldCheck className="w-5 h-5 text-cyan-700 dark:text-signal-cyan" />
              <span>Bảo hành 24 tháng</span>
            </div>
            <div className="flex flex-col items-center gap-1">
              <Truck className="w-5 h-5 text-cyan-700 dark:text-signal-cyan" />
              <span>Giao hỏa tốc 2h</span>
            </div>
            <div className="flex flex-col items-center gap-1">
              <RotateCcw className="w-5 h-5 text-cyan-700 dark:text-signal-cyan" />
